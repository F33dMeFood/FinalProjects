...
Grocery_List = [['Apple', 0.79, 0],['Apricot', 1.09, 1],['Banana', 0.89,
2],['Blueberry', 0.09, 3],['Cherry', 0.79, 4],['Coconut', 3.49, 5]]
run = True
...
cost = make_sure_type_input("Enter the cost", "Float")
quantity = make_sure_type_input("Enter the quantity", "Integer")
